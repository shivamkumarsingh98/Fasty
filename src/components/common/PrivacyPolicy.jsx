...
const PrivacyPolicy = () => {
  return (
    <div className="bg-white p-10">
      ...
      <p className="mb-4">
        At FASTY, accessible from www.fastynow.shop, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by FASTY and how we
        use it.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        shared and/or collect in FASTY. This policy is not applicable to any
        information collected offline or via channels other than this website.
      </p>

      <h2 className="text-3xl font-bold mt-6 mb-2">Consent</h2>
      <p className="mb-4">
        By using our website, you hereby consent to our Privacy Policy and agree
        to its terms.
      </p>

      <h2 className="text-3xl font-bold mt-6 mb-2">Information we collect</h2>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold mt-6 mb-2">How we use your information</h2>
      <p className="mb-4">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          Log Files: FASTY follows a standard procedure of using log files. These files log
      ...
      <h2 className="text-3xl font-bold mt-6 mb-2">Advertising Partners Privacy Policies</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        links that appear on FASTY, which are sent directly to users' browser. They
      ...
      <p className="mb-4">
        Note that FASTY has no access to or control over these cookies that are used by
        third-party advertisers.
      </p>

      <h2 className="text-3xl font-bold mt-6 mb-2">Third Party Privacy Policies</h2>
      <p className="mb-4">
        FASTY's Privacy Policy does not apply to other advertisers or websites. Thus, we
      ...
      <h2 className="text-3xl font-bold mt-6 mb-2">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold mt-6 mb-2">GDPR Data Protection Rights</h2>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold mt-6 mb-2">Children's Information</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        FASTY does not knowingly collect any Personal Identifiable Information from
      ...
      <p className="mb-4">
        For more details, visit our official website: <a href="http://www.fastynow.shop" className="text-blue-500">www.fastynow.shop</a>
      </p>
    </div>
  );
}   
